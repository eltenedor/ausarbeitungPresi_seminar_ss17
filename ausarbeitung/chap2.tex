...
\subsection[Reflektoren und Coreflektoren in topologischen Konstrukten]{Reflektoren und Coreflektoren\\ in topologischen Konstrukten}
...
\begin{thm}[\cite{preuss}, 2.2.9]
  Sei $S$ ein Separator einer Kategorie $\C$ und $\A$ eine coreflektive Unterkategorie von $\C$, die $S$ enthält.
...
\begin{thm}[\cite{preuss}, 2.2.10]
  Sei $\A$ eine epicoreflektive Unterkategorie von $\C$. 
  Ist $\A$ zusätzlich eine \emph{volle} Unterkategorie, so ist $\A$ bereits bicoreflektiv.
\end{thm}

\begin{bem}[\cite{preuss}, 2.2.11]
